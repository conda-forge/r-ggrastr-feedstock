...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-ggrastr-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11051&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-ggrastr-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-ggrastr` can be installed with:

```
conda install r-ggrastr
```

It is possible to list all of the versions of `r-ggrastr` available on your platform with:
